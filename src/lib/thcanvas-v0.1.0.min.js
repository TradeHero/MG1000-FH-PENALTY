/*! THCanvas v0.1.0 2014-12-24 http://www.tradehero.mobi by TradeHero */
var Assets = function () {
    "use strict";
    var a, b = function (a) {
        ...
        for (var e in d)d.hasOwnProperty(e) && (a = d[e], function (b, c) {
            d[c] = new Image, d[c].status = "loading", d[c].name = c, d[c].onload = function () {
                ...
                var Assets = function () {
                ...
                }(this), UniqueIdCookieManager = function () {
                    function a(a) {
                        document.cookie = a + "=" + uuid.v4() + "; expires=Tue, 19 Jan 2038 03:14:07 GMT"
                    }

                    function b(a) {
                        var b = document.cookie, c = a + "=", d = b.indexOf("; " + c);
                        if (-1 == d) {
                    ...
                    return function () {
                        ...
                        function c(a, c, d) {
                            var e = c && d || 0, f = c || [];
                            a = a || {};
                            var g = null != a.clockseq ? a.clockseq : q, h = null != a.msecs ? a.msecs : (new Date).getTime(), i = null != a.nsecs ? a.nsecs : s + 1, j = h - r + (i - s) / 1e4;
                            ...
                            r = h, s = i, q = g, h += 122192928e5;
                            var k = (1e4 * (268435455 & h) + i) % 4294967296;
                            f[e++] = k >>> 24 & 255, f[e++] = k >>> 16 & 255, f[e++] = k >>> 8 & 255, f[e++] = 255 & k;
                            var l = h / 4294967296 * 1e4 & 268435455;
                            f[e++] = l >>> 8 & 255, f[e++] = 255 & l, f[e++] = l >>> 24 & 15 | 16, f[e++] = l >>> 16 & 255, f[e++] = g >>> 8 | 128, f[e++] = 255 & g;
                            for (var m = a.node || p, n = 0; 6 > n; n++)f[e + n] = m[n];
                            return c ? c : b(f)
                        }

                        function d(a, c, d) {
                            var f = c && d || 0;
                            "string" == typeof a && (c = "binary" == a ? new k(16) : null, a = null), a = a || {};
                        ...
                        var e, f = this;
                        if ("function" == typeof f.require)try {
                            var g = f.require("crypto").randomBytes;
                            e = g && function () {
                                return g(16)
                            }
                        } catch (h) {
                        ...
                        if (!e) {
                            var j = new Array(16);
                            e = function () {
                                for (var a, b = 0; 16 > b; b++)0 === (3 & b) && (a = 4294967296 * Math.random()), j[b] = a >>> ((3 & b) << 3) & 255;
                                return j
                            }
                        }
                        for (var k = "function" == typeof f.Buffer ? f.Buffer : Array, l = [], m = {}, n = 0; 256 > n; n++)l[n] = (n + 256).toString(16).substr(1), m[l[n]] = n;
                        var o = e(), p = [1 | o[0], o[1], o[2], o[3], o[4], o[5]], q = 16383 & (o[6] << 8 | o[7]), r = 0, s = 0, t = d;
                        if (t.v1 = c, t.v4 = d, t.parse = a, t.unparse = b, t.BufferClass = k, "function" == typeof define && define.amd)define(function () {
                            return t
                        }); else if ("undefined" != typeof module && module.exports)module.exports = t; else {
                            var u = f.uuid;
                            t.noConflict = function () {
                                return f.uuid = u, t
                            }, f.uuid = t
                        }
                    }.call(this), {setCookie: a, getCookie: b, cookieExistForName: d, deleteCookie: c}
                }();
            }, d[c].src = a
        }(c, e))
    };
